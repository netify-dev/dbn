...
# this vignette requires peacesciencer and ggplot2
has_deps = requireNamespace("peacesciencer", quietly = TRUE) &&
...
```{r alignment-timeseries, fig.height = 5}
...
```{r plot-irf-compare, fig.height = 5, fig.width = 8}
