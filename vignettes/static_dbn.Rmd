...
`summary()` shows posterior means and credible intervals for the variance parameters. `param_summary()` returns a tidy data frame for further analysis or plotting.
...
For models with time-varying parameters, see `vignette("dynamic_dbn")`.
